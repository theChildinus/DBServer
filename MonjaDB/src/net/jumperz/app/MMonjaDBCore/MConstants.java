...
public static final String SAVED_ACTION = PublicResource.getString("MSavedActionSavedAction");
public static final String CONSOLE_NAME =PublicResource.getString("MConsoleLog");
