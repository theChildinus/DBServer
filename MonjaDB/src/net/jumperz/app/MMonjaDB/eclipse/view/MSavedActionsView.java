...
if( selected == null || selected.length != 1 )
	...
	if( isFolderItem( selected[ 0 ] ) )
		...
		MPromptDialog dialog = new MPromptDialog( shell, dataSet, PublicResource.getString("MSavedActionRenameFolder"), PublicResource.getString("MSavedActionNewName")+" :", ( String )data.get( "name" ) );
		dialog.open();
		if( dataSet.size() > 0 )
			{
...
if( selected == null || selected.length != 1 || isRootItem( selected[ 0 ] ) )
	...
	dialog.setText(PublicResource.getString("MSavedActionConfirmRemove1"));
	dialog.setMessage(PublicResource.getString("MSavedActionConfirmRemove2"));
...
executeAction.setToolTipText(PublicResource.getString("MSavedActionExecute"));
executeAction.setText( PublicResource.getString("MSavedActionExecute")+"\tShift+Enter" );
initAction( executeAction, "cog_go.png", menuManager );

editAction = new Action(){ public void run(){//-----------
onEdit();
}};//-----------
editAction.setToolTipText(PublicResource.getString("MSavedActionEdit"));
editAction.setText( PublicResource.getString("MSavedActionEdit"));
...
newAction.setToolTipText(PublicResource.getString("MSavedActionNew"));
newAction.setText( PublicResource.getString("MSavedActionNew") );
initAction( newAction, "cog_add.png", menuManager );

newFolderAction = new Action(){ public void run(){//-----------
onNewFolder();
}};//-----------
newFolderAction.setToolTipText(PublicResource.getString("MSavedActionNewFolder"));
newFolderAction.setText( PublicResource.getString("MSavedActionNewFolder") );
...
removeAction.setToolTipText(PublicResource.getString("MSavedActionDelete"));
removeAction.setText( PublicResource.getString("MSavedActionDelete") );
...
if( savedStr == null )
	...
	rootData.put( "name", PublicResource.getString("MSavedActionSavedAction") );
	rootData.put( "root", "1" );
