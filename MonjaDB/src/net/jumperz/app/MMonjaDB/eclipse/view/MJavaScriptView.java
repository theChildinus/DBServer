...
executeAction.setToolTipText( PublicResource.getString("MJavaScriptExecute") );
executeAction.setText( PublicResource.getString("MJavaScriptExecute") );
...
clearAction.setToolTipText( PublicResource.getString("MJavaScriptClear") );
clearAction.setText( PublicResource.getString("MJavaScriptClear") );
