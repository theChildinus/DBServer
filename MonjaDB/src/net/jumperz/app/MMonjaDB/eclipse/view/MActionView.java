...
actionColumn.setText(PublicResource.getString("MActionAction"));
TableColumn dateColumn = new TableColumn(table, SWT.NONE);
dateColumn.setWidth(100);
dateColumn.setText(PublicResource.getString("MActionDate"));
...
executeButton.setText(PublicResource.getString("MActionExecute"));
...
redoAction.setToolTipText( PublicResource.getString("MActionRedoSelectedActions") );
redoAction.setText( PublicResource.getString("MActionRedoSelectedActions")+"\tShift+Enter" );
...
editAction.setToolTipText( PublicResource.getString("MActionEditAction") );
editAction.setText( PublicResource.getString("MActionEditAction")+"\tEnter" );
...
executeAction.setToolTipText( PublicResource.getString("MActionExecuteTextArea") );
executeAction.setText( PublicResource.getString("MActionExecuteTextArea") );
...
copyAction.setToolTipText( PublicResource.getString("MActionCopy") );
copyAction.setText( PublicResource.getString("MActionCopy") );
...
clearAction.setToolTipText( PublicResource.getString("MActionClearAll") );
clearAction.setText( PublicResource.getString("MActionClearAll") );
...
saveAction.setToolTipText( PublicResource.getString("MActionSaveAction") );
saveAction.setText( PublicResource.getString("MActionSaveAction") );
