...
import net.jumperz.app.MMonjaDB.eclipse.pref.MCollectionPage;
...
if( event.type == SWT.Selection )
	...
	if( event.widget == connectItem )
		...
		{
//		PreferenceDialog dialog = PreferencesUtil.createPreferenceDialogOn( null, "net.jumperz.app.MMonjaDB.eclipse.pref.MViewPage", null, null );
//		dialog.open();
