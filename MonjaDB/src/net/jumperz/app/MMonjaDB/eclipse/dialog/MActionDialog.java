...
newShell.setText( PublicResource.getString("MActionDialogSavedAction") );
...
nameLabel.setText( PublicResource.getString("MActionDialogName") );
...
actionLabel.setText( PublicResource.getString("MActionDialogActions"));
