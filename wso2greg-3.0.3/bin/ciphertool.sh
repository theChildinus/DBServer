...
# update classpath
CARBON_CLASSPATH=""
for f in "$CARBON_HOME"/webapps/ROOT/WEB-INF/plugins/common/synapse-*.jar
do
  CARBON_CLASSPATH=$CARBON_CLASSPATH:$f
done
for f in "$CARBON_HOME"/webapps/ROOT/WEB-INF/plugins/common/commons-*.jar
do
  CARBON_CLASSPATH=$CARBON_CLASSPATH:$f
done
for f in "$CARBON_HOME"/lib/commons-*.jar
do
  CARBON_CLASSPATH=$CARBON_CLASSPATH:$f
done
