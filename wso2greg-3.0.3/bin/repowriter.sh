...
-Dcarbon.home="$CARBON_HOME" -Dwso2.carbon.xml="$CARBON_HOME/conf/carbon.xml" -Dserver.script=$0 \
-Dwso2.transports.xml=" " \
org.wso2.carbon.server.RepositoryMetadataWriter $*
