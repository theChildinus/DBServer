...
FOR %%C in ("%CARBON_HOME%\lib\patches\*.jar") DO set CARBON_PATCH_CLASSPATH=!CARBON_PATCH_CLASSPATH!;".\lib\patches\%%~nC%%~xC"

set CARBON_CLASSPATH=%CARBON_PATCH_CLASSPATH%;.\lib;%CARBON_CLASSPATH%

set JAVA_ENDORSED=".\lib\endorsed";"%JAVA_HOME%\jre\lib\endorsed";"%JAVA_HOME%\lib\endorsed"

"%JAVA_HOME%\bin\java" -Xbootclasspath/a:%CARBON_XBOOTCLASSPATH% -Xms256m -Xmx512m -XX:MaxPermSize=128m -Dimpl.prefix=Carbon -Dcom.sun.management.jmxremote -classpath %CARBON_CLASSPATH% %JAVA_OPTS% -Djava.endorsed.dirs=%JAVA_ENDORSED% -Dcarbon.registry.root=/ -Dcarbon.home="%CARBON_HOME%" -Dwso2.server.standalone=true -Djava.io.tmpdir="%CARBON_HOME%\tmp" -Dwso2.carbon.xml=%CARBON_HOME%\conf\carbon.xml -Dwso2.transports.xml="%CARBON_HOME%\conf\transports.xml" -Djava.util.logging.config.file="%CARBON_HOME%\lib\log4j.properties" org.wso2.carbon.server.Main %CMD%
