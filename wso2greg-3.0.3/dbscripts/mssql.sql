...
CREATE TABLE  REG_PATH(
             ...
             REG_PATH_VALUE VARCHAR(899) NOT NULL,
...
CREATE INDEX REG_RESOURCE_HISTORY_IND_BY_PATH_ID_NAME ON REG_RESOURCE_HISTORY(REG_PATH_ID, REG_NAME);
...
CREATE TABLE  REG_RESOURCE_COMMENT (
            ...
            REG_TENANT_ID INTEGER DEFAULT 0,
            CONSTRAINT PK_REG_RESOURCE_COMMENT PRIMARY KEY(REG_COMMENT_ID)
);
...
CREATE TABLE  REG_RESOURCE_RATING (
            ...
            REG_RESOURCE_NAME       VARCHAR(256),
            REG_TENANT_ID INTEGER DEFAULT 0,
            CONSTRAINT PK_REG_RESOURCE_RATING PRIMARY KEY(REG_RATING_ID)
);
...
CREATE TABLE   REG_RESOURCE_TAG (
            ...
            REG_RESOURCE_NAME       VARCHAR(256),
            REG_TENANT_ID INTEGER DEFAULT 0,
            CONSTRAINT PK_REG_RESOURCE_TAG PRIMARY KEY(REG_TAG_ID)
);
...
CREATE TABLE  REG_RESOURCE_PROPERTY (
            ...
            REG_RESOURCE_NAME       VARCHAR(256),
            REG_TENANT_ID INTEGER DEFAULT 0,
            CONSTRAINT PK_REG_RESOURCE_PROPERTY PRIMARY KEY(REG_PROPERTY_ID)
);
...
IF NOT EXISTS (SELECT * FROM SYS.OBJECTS WHERE OBJECT_ID = OBJECT_ID(N'[dbo].[UM_ROLE_ATTRIBUTE]') AND TYPE IN (N'U'))
CREATE TABLE  UM_ROLE_ATTRIBUTE (
             UM_ID INTEGER IDENTITY(1,1) NOT NULL,
             UM_ATTR_NAME VARCHAR(255) NOT NULL,
...
CREATE INDEX INDEX_UM_PERMISSION_UM_RESOURCE_ID_UM_ACTION ON UM_PERMISSION (UM_RESOURCE_ID, UM_ACTION);
...
CREATE TABLE UM_BIN_DATA (
       	UM_ID INTEGER IDENTITY(1, 1),
            ...
            UM_CONTENT VARBINARY(MAX) NOT NULL,
